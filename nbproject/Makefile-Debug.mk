...
LDLIBSOPTIONS=-lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio -lsfml-network -lpthread
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mandelbrot: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mandelbrot ${OBJECTFILES} ${LDLIBSOPTIONS}
